...
# Substantially copied from rietveld:
#   http://code.google.com/p/rietveld.

"""Main program for Lantern demo.
...
# Remove standard version of Django
...
#
# NOTE: Workaround may not be needed for Django 1.1, so commented out.
...
def real_main():
  """Main program."""
  # Don't ask. :-(
  if os.getenv('HTTP_HOST') == _APPLICATION_ID + '.appspot.com':
